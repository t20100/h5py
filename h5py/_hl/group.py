...
from .plist import convert_file_locking
from . import dataset
...
def make_lapl(
    ...
    if elink_locking is not None:
        ...
        fapl.set_file_locking(*convert_file_locking(elink_locking))
...
class Group(HLObject, MutableMappingHDF5):
    ...
    def get(
        ...
        elink_locking
            External links file locking behavior. Defined as:
            ...
            .. warning::
                ...
                this parameter.
        elink_swmr
            External link SWMR read mode. Only used when mode = 'r'.
